...
def Create_restaurant(requset):
    category_id = requset.POST['resCategory']
    category = Category.objects.get(id = category_id)
    name = requset.POST['resTitle']
    link = requset.POST['resLink']
    content = requset.POST['resContent']
    keyword = requset.POST['resLoc']
...
def Delete_category(request):
    ...
    #return HttpResponse("여기서 카테고리 생성 기능이 구현 됩니다.")
